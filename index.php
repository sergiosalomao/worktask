<?php
    require_once "app/Definicoes.php";
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href="app/view/pages/css/estilos_default.css">
    <!--bootstrap-->
...
<div  class="boxspace login" >
    ...
    <div class="boxspace lg bg-white">
        ...
        <form action =<?php echo PATH_PAGES?>painelControle.php>
